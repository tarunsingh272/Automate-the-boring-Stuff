def send_email(week_num, report_name):
    ...
    msg['Subject'] = 'Weekly Report - From MSBA Trends PPTX Team'
    ...
    body = email.mime.text.MIMEText("Report for Week " + str(week_num) +
                                    ...
                                    "\n\nHenrik Kowalkowski - kowal230@umn.edu" +
                                    "\nTarun Singh - singh899@umn.edu" +
                                    "\nVishal Reddy - raju0013@umn.edu" +
                                    "\nSiddhesh Kothari - kotha039@umn.edu" +
                                    "\nWilliam Summitt - summi010@umn.edu" +
                                    "\nShashank Singh - singh844@umn.edu")
    msg.attach(body)
